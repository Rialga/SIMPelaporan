    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Detial Laporan</h5>
                            ...
                            <table width="400">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <a class="text-gray" id="ddoc_pendukung_nama"></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                ...
                <div class="modal-body">
                    <form id="formlaporan">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="laporan_no" name="laporan_no" placeholder="NO Lapor">
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#detail', function() {
                ...
                $('#ddoc_pendukung_nama').text(data.doc_pendukung.doc_pendukung_nama);
                $('#ddoc_pendukung_file').attr('src','DocumentLaporan/'+data.doc_pendukung.doc_pendukung_file);
            });
        });
        </script>
@else
