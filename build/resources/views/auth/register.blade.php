                ...
                <div class="card-body">
                    <form method="POST" action="user/create">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="user_nama" type="text" class="form-control @error('user_nama') is-invalid @enderror" name="user_nama" value="{{ old('user_nama') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="user_pangkat" type="text" class="form-control @error('user_pangkat') is-invalid @enderror" name="user_pangkat" value="{{ old('user_pangkat') }}" required autocomplete="name" autofocus>
